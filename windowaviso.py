...
class Ui_windowaviso(object):
    def setupUi(self, windowaviso):
        ...
        Código obtenido del fichero xml generado por QtDesigner correspondiente a la interfaz gráfica de avisos.
        ...
        self.lblmageAviso.setPixmap(QtGui.QPixmap(":/newPrefix/warning.png"))
        ...
        self.btnBoxAviso.accepted.connect(windowaviso.accept) # type: ignore
        self.btnBoxAviso.rejected.connect(windowaviso.reject) # type: ignore
