...
"}")
        ...
        self.btnRecarga.setGeometry(QtCore.QRect(330, 40, 41, 31))
        ...
        self.btnReportCli.setGeometry(QtCore.QRect(700, 280, 35, 20))
        ...
        self.btnReportCli.setIconSize(QtCore.QSize(35, 35))
        self.btnReportCli.setObjectName("btnReportCli")
        self.btnPDFCli = QtWidgets.QPushButton(self.groupBox)
        self.btnPDFCli.setGeometry(QtCore.QRect(660, 280, 35, 20))
        self.btnPDFCli.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("img/eye.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btnFacturar.setGeometry(QtCore.QRect(430, 80, 36, 28))
        self.btnFacturar.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("img/factura.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnFacturar.setIcon(icon4)
        self.btnFacturar.setIconSize(QtCore.QSize(26, 26))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("img/lupa.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.layoutWidget10.setGeometry(QtCore.QRect(10, 70, 311, 31))
        ...
        self.layoutWidget12.setGeometry(QtCore.QRect(330, 20, 171, 31))
        ...
        self.txtNumFac = QtWidgets.QLabel(self.layoutWidget12)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btnImprimirFactura.setGeometry(QtCore.QRect(480, 80, 36, 28))
        self.btnImprimirFactura.setText("")
        self.btnImprimirFactura.setIcon(icon2)
        self.btnImprimirFactura.setIconSize(QtCore.QSize(32, 32))
        self.btnImprimirFactura.setObjectName("btnImprimirFactura")
        self.btnEliminarVenta = QtWidgets.QPushButton(self.frame)
        self.btnEliminarVenta.setGeometry(QtCore.QRect(780, 80, 36, 28))
        self.btnEliminarVenta.setMinimumSize(QtCore.QSize(36, 28))
        ...
        self.tabFacturas.setGeometry(QtCore.QRect(0, 190, 200, 451))
        self.tabFacturas.setMinimumSize(QtCore.QSize(180, 300))
        self.tabFacturas.setMaximumSize(QtCore.QSize(200, 16777215))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(9)
        self.tabFacturas.setFont(font)
        self.tabFacturas.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.tabFacturas.setAutoFillBackground(False)
        self.tabFacturas.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.tabFacturas.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.tabFacturas.setAutoScrollMargin(10)
        self.tabFacturas.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tabFacturas.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerItem)
        ...
        self.frame_2.setGeometry(QtCore.QRect(220, 180, 631, 391))
        self.frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.tabVentas = QtWidgets.QTableWidget(self.frame_2)
        self.tabVentas.setGeometry(QtCore.QRect(10, 10, 600, 360))
        self.tabVentas.setMinimumSize(QtCore.QSize(600, 360))
        self.tabVentas.setMaximumSize(QtCore.QSize(650, 360))
        ...
        self.lblNomFac_2.setGeometry(QtCore.QRect(410, 160, 150, 16))
        self.lblNomFac_2.setMaximumSize(QtCore.QSize(150, 16))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.lblNomFac_2.setStyleSheet("background-color:rgb(254, 255, 185);")
        self.lblNomFac_2.setAlignment(QtCore.Qt.AlignCenter)
        self.lblNomFac_2.setObjectName("lblNomFac_2")
        self.lblNomFac_3 = QtWidgets.QLabel(self.tab_2)
        self.lblNomFac_3.setGeometry(QtCore.QRect(0, 160, 150, 16))
        self.lblNomFac_3.setMaximumSize(QtCore.QSize(150, 16))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.lblNomFac_3.setStyleSheet("background-color:rgb(254, 255, 185);")
        ...
        self.lblVenta.setGeometry(QtCore.QRect(450, 590, 100, 20))
        ...
        self.lblVenta.setStyleSheet("background-color:rgb(254, 255, 185);")
        ...
        self.lblVenta_2.setGeometry(QtCore.QRect(620, 570, 100, 20))
        ...
        self.lblVenta_2.setStyleSheet("background-color:rgb(254, 255, 185);")
        ...
        self.lblVenta_3.setGeometry(QtCore.QRect(620, 600, 100, 20))
        self.lblVenta_3.setMinimumSize(QtCore.QSize(100, 20))
        ...
        self.lblVenta_3.setStyleSheet("background-color:rgb(254, 255, 185);")
        ...
        self.lblVenta_4.setGeometry(QtCore.QRect(620, 630, 100, 20))
        self.lblVenta_4.setMinimumSize(QtCore.QSize(100, 20))
        ...
        self.lblVenta_4.setStyleSheet("background-color:rgb(254, 255, 185);")
        ...
        self.lblSubtotal.setGeometry(QtCore.QRect(730, 570, 100, 20))
        ...
        self.lblSubtotal.setStyleSheet("background-color:rgb(255, 178, 147);")
        ...
        self.lblIva.setGeometry(QtCore.QRect(730, 600, 100, 20))
        ...
        self.lblTotal.setStyleSheet("background-color:rgb(255, 178, 147);")
        ...
        self.layoutWidget13.setGeometry(QtCore.QRect(220, 100, 313, 24))
        ...
        self.lblPrecio = QtWidgets.QLabel(self.layoutWidget14)
        ...
        self.layoutWidget15.setGeometry(QtCore.QRect(220, 220, 239, 26))
        ...
        self.layoutWidget16.setGeometry(QtCore.QRect(220, 60, 121, 21))
        ...
        self.label_2 = QtWidgets.QLabel(self.layoutWidget16)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_13.addWidget(self.label_2)
        self.lblCod = QtWidgets.QLabel(self.layoutWidget16)
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.lblCod.setText("")
        self.lblCod.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.lblFecha.setGeometry(QtCore.QRect(10, 750, 91, 16))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(8)
        ...
        icon7.addPixmap(QtGui.QPixmap("img/salir.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("img/restaurar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon8.addPixmap(QtGui.QPixmap("img/restaurar.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("img/backup2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon9.addPixmap(QtGui.QPixmap("img/backup2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionbarBackup.setIcon(icon9)
        self.actionbarBackup.setObjectName("actionbarBackup")
        self.actionbarAbrir = QtWidgets.QAction(window)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("img/abrir2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbarAbrir.setIcon(icon10)
        ...
        icon11.addPixmap(QtGui.QPixmap("img/impresora.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
    ...
    def retranslateUi(self, window):
        ...
        item.setText(_translate("window", "Cod"))
        ...
        self.lblNomFac_2.setText(_translate("window", "VENTAS"))
        self.lblNomFac_3.setText(_translate("window", "Nº               Fecha"))
        self.lblVenta_2.setText(_translate("window", "Subtotal:"))
        self.lblVenta_3.setText(_translate("window", "IVA:"))
        self.lblVenta_4.setText(_translate("window", "Total:"))
