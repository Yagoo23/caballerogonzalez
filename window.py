...
"}")
        ...
        self.btnImprimirFactura.setGeometry(QtCore.QRect(780, 80, 36, 28))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("img/salir.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon5.addPixmap(QtGui.QPixmap("img/salir.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("img/restaurar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon6.addPixmap(QtGui.QPixmap("img/restaurar.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("img/backup2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon7.addPixmap(QtGui.QPixmap("img/backup2.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionbarBackup.setIcon(icon7)
        self.actionbarBackup.setObjectName("actionbarBackup")
        self.actionbarAbrir = QtWidgets.QAction(window)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("img/abrir2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionbarAbrir.setIcon(icon8)
        self.actionbarAbrir.setObjectName("actionbarAbrir")
        self.actionbarImprimir = QtWidgets.QAction(window)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("img/impresora.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon9.addPixmap(QtGui.QPixmap("img/impresora.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionbarImprimir.setIcon(icon9)
